...
COMMENT ON COLUMN   area.id               IS  'Identificador único para cada registro en la tabla Área.';
COMMENT ON COLUMN   area.nombre           IS  'Nombre del Área de división de libros en la biblioteca.';
COMMENT ON COLUMN   area.ubicacion        IS  'Ubicación del Área dentro de la biblioteca.';
...
CREATE TABLE direccionEditorial (
  ...
  referencia VARCHAR2(100) DEFAULT NULL  ,
  PRIMARY KEY (id)
) ;
...
COMMENT ON COLUMN biblioteca.id            IS  'Identificador único para cada registro en la tabla biblioteca.';
...
COMMENT ON COLUMN editorial.id                    IS  'Identificador único para cada registro en la tabla Editorial.';
...
COMMENT ON COLUMN evento.id                            IS      'Identificador único para cada registro en la tabla Evento';
...
COMMENT ON COLUMN formaPago.id                  IS     'Identificador único para cada registro en la tabla Forma_de_Pago';
COMMENT ON COLUMN formaPago.tipo                  IS     'Tipo de forma de pago.';
...
COMMENT ON COLUMN formatoLibro.id               IS  'Identificador único para cada registro en la tabla Formato_Libro';
...
CREATE TABLE persona(
  ...
  nombre2 VARCHAR2(500),
  apellido1 VARCHAR2(45)  NOT NULL,
  apellido2 VARCHAR2(500),
  correoElectronico VARCHAR2(45),
  fechaNacimiento DATE,
  PRIMARY KEY (id)
) ;

COMMENT ON COLUMN persona.id                     IS 'Identificador único para cada registro en la tabla Persona.';
COMMENT ON COLUMN persona.nombre1                IS 'Primer nombre de la persona.';
COMMENT ON COLUMN persona.nombre2                IS 'Segundo o tercer nombre de la persona.';
COMMENT ON COLUMN persona.apellido1              IS 'Primer apellido de la persona.';
COMMENT ON COLUMN persona.apellido2              IS 'Segundo o tercer apellido de la persona.';
...
COMMENT ON COLUMN sugerencia.contenido      IS 'Contenido de la sugerencia.';
COMMENT ON COLUMN sugerencia.usuario_id     IS 'Usuario asociado a la sugerencia.';
...
COMMENT ON COLUMN telefono.id                 IS  'Identificador único para cada registro en \nla tabla Teléfono.';
COMMENT ON COLUMN telefono.numTelefono                 IS  'Número de teléfono asociado.';
COMMENT ON COLUMN telefono.tipo                 IS  'Tipo de número telefónico.';
COMMENT ON COLUMN telefono.operador                 IS  'Operador del número telefónico.\r';
COMMENT ON COLUMN telefono.persona_id                 IS  'Persona asociada a número telefónico';
COMMENT ON COLUMN telefono.editorial_id                 IS  'Editorial asociada a número telefónico.\r';
...
COMMENT ON COLUMN prestamo.fechaPrestamo                 IS      'Fecha de adquisición de préstamo.';
COMMENT ON COLUMN prestamo.fechaRegreso                  IS      'Fecha de retorno del préstamo.';
COMMENT ON COLUMN prestamo.estadoPrestamo                IS      'Estado de préstamo del libro.';
COMMENT ON COLUMN prestamo.usuario_id                    IS      'Usuario asociado a préstamo.';
COMMENT ON COLUMN prestamo.libro_id                      IS      'Libro asociado a préstamo.';
...
COMMENT ON COLUMN libroVendido.libro_id             IS  'Libro asociado a venta.';
...
CREATE INDEX fk_Donación_Persona1_idx ON donacion(persona_id);
...
COMMENT ON COLUMN 	estante.numEstante			          IS 				'Numero asociado a estante.';
...
COMMENT ON COLUMN cubiculo.id IS 'Identificador único para cada registro en la tabla cubículo';
COMMENT ON COLUMN cubiculo.posicion IS 'Posición del cubículo en el estante asociado.';
COMMENT ON COLUMN cubiculo.ubicacion IS 'Ubicación del cubículo dentro del estante.';
...
COMMENT ON COLUMN descuento.id IS 'Identificador único para cada registro en la tabla descuento';
COMMENT ON COLUMN descuento.fechaInicio IS 'Fecha de inicio de establecimiento del descuento.';
COMMENT ON COLUMN descuento.fechaFin IS 'Fecha de finalización de establecimiento del descuento.';
COMMENT ON COLUMN descuento.tipoDescuento IS 'Tipo de descuento, dependiendo de la membresía aplicada en la compra del usuario.';
COMMENT ON COLUMN descuento.porcentaje IS 'Porcentaje del descuento';
COMMENT ON COLUMN descuento.detalleFactura_id IS 'Detalles de factura asociados a descuento.';
...
COMMENT ON COLUMN sancion.id IS 'Identificador único para cada registro en la tabla Sanción.';
COMMENT ON COLUMN sancion.tipo IS 'Tipo de sanción.';
COMMENT ON COLUMN sancion.cantidadMultas IS 'Cantidad de multas asociadas a la sanción aplicada.';
COMMENT ON COLUMN sancion.usuario_id IS 'Usuario asociado a sanción aplicada.';
COMMENT ON COLUMN sancion.libroPerdido_id IS 'Libros perdidos asociados a sanción.';
...
CREATE INDEX      fk_Membresía_has_Descuento_Autor1_idx                 ON      SubArea_has_Autor(autor_id);
CREATE INDEX      fk_Membresía_has_Descuento_SubArea_idx                 ON      SubArea_has_Autor(subArea_id);
